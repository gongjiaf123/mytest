...
var
  Account_airForm: TAccount_airForm;
...
procedure TAccount_airForm.SetTable(Value: TDataSet);
 Var
  TempSql:String;
begin
//
...
procedure TAccount_airForm.BitBtn4Click(Sender: TObject);
begin
 Close;
end;

procedure TAccount_airForm.BitPostClick(Sender: TObject);
 Var
  Tempsql:String;
  TempSf,ihl:String;
begin
...
procedure TAccount_airForm.FormClose(Sender: TObject;
...
procedure TAccount_airForm.account_fydStateChange(Sender: TObject);
begin
...
procedure TAccount_airForm.DataSource1StateChange(Sender: TObject);
begin
...
procedure TAccount_airForm.FormActivate(Sender: TObject);
begin
 Change_Fy:=False;
 FDeleted:=False;
 FInserted:=False;
...
procedure TAccount_airForm.MsfdwButtonClick(Sender: TObject);
 Var
...
procedure TAccount_airForm.MfpttButtonClick(Sender: TObject);
 Var
  MTemp,Mtemp_nxr,Mtemp_dh,Mtemp_cz,MTemp_dz:String;
  Mtc:Integer;
begin
...
procedure TAccount_airForm.RxDBComboEdit4ButtonClick(Sender: TObject);
 Var
  MTemp,Mtemp_nxr,Mtemp_dh,Mtemp_cz,MTemp_dz:String;
  Mtc:Integer;
begin
...
procedure TAccount_airForm.BitBtn3Click(Sender: TObject);
Var
  TempDir:String;
begin
   If mzdlx.text = '我方应收' Then
   TempDir:='export_air_debit'
   Else TempDir:='export_air_credit';
...
procedure TAccount_airForm.BitBtn1Click(Sender: TObject);
 Var
  TempSql:String;
  Temp_Xh:String;
begin
...
procedure TAccount_airForm.account_fyNewRecord(DataSet: TDataSet);
begin
...
procedure TAccount_airForm.Sr_addClick(Sender: TObject);
begin
...
procedure TAccount_airForm.BitBtn2Click(Sender: TObject);
begin
 IF Account_fy.Active = False Then Exit;
...
procedure TAccount_airForm.Sp_DelClick(Sender: TObject);
begin
 IF Account_fy.Active = False Then Exit;
...
procedure TAccount_airForm.DBGrid6ColEnter(Sender: TObject);
begin
...
procedure TAccount_airForm.DBGrid6ColExit(Sender: TObject);
var
  TempSql:String;
  sFy:string;
...
//****************************fy离开事件**************************************//
  ...
  begin
    ...
    TempSql:='select * from code_fy where dm = '+Quotedstr(sFy);
    Modal.Temp.Close;
...
procedure TAccount_airForm.DBGrid6Columns2EditButtonClick(Sender: TObject;
  var Handled: Boolean);
Var
  MTemp:String;
begin
...
procedure TAccount_airForm.DBGrid6Columns3EditButtonClick(Sender: TObject;
  var Handled: Boolean);
Var
...
procedure TAccount_airForm.Sp_EditClick(Sender: TObject);
begin
  If Account_fy.IsEmpty Then Exit;
    Account_fy.Edit;
end;

procedure TAccount_airForm.Sp_cancelClick(Sender: TObject);
begin
  IF Account_fy.State in [dsEdit,dsInsert] Then
    Account_fy.Cancel;
end;

procedure TAccount_airForm.CalcClick(Sender: TObject);
Var
  BookMark:TBookMark;
  I,J,K:Integer;
  F_Bwb:Real;
...
procedure TAccount_airForm.DBGrid6DblClick(Sender: TObject);
 Var
  A:Boolean;
begin
 If Account_fy.Active = False Then Exit;
...
procedure TAccount_airForm.account_fyBeforeDelete(DataSet: TDataSet);
begin

 If FDeleted = False Then Abort;
end;

procedure TAccount_airForm.account_fyBeforeInsert(DataSet: TDataSet);
begin
 IF FInserted = False Then Abort;
end;

procedure TAccount_airForm.NhbExit(Sender: TObject);
begin
 CalcClick(Self);
end;

procedure TAccount_airForm.MFphButtonClick(Sender: TObject);
Var
  TempSql:String;
  Fbh:String;
  FRq:String;
...
procedure TAccount_airForm.BitBtn5Click(Sender: TObject);
Var
  BookMark:TBookMark;
  I,J,K:Integer;
  F_Bwb:Real;
...
procedure TAccount_airForm.DBGrid6KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TAccount_airForm.MDEPTButtonClick(Sender: TObject);
var
  MTemp:string;
begin
...
procedure TAccount_airForm.NhbChange(Sender: TObject);
begin
edthl.Text :=GetHL(sDlr,nhb.Text);
end;

function TAccount_airForm.GetHl(Value, hb: string): String;
var
  TempSql:string;
begin
...
procedure TAccount_airForm.DjExit(Value: TDataSet);
begin
